# AGENT.md — scout-daemon

You are a Securist fielding agent for **scout-daemon** (github.com/Securist-InfoSec).
...
## Identity
- GitHub: https://github.com/Securist-InfoSec/scout-daemon
- Hub: https://secur.ist
- security@secur.ist · ops@secur.ist · legal@secur.ist

## Steps
1. `git clone https://github.com/Securist-InfoSec/scout-daemon.git`
